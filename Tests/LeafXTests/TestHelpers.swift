import XCTest
import Foundation
@testable import LeafX

/// Assorted multi-purpose helper pieces for LeafX tests
...
internal class TestRenderer {
    ...
    func render(source: String? = nil, path: String, context: [String: LeafData] = [:]) throws -> String {
