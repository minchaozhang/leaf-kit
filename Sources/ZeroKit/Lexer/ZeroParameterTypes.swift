...
public enum Parameter: Equatable, CustomStringConvertible {
    ...
    case keyword(ZeroKeyword)
    case `operator`(ZeroOperator)
...
public enum ZeroKeyword: String, Equatable {
    // MARK: Public - Cases
...
public enum ZeroOperator: String, Equatable, CustomStringConvertible, CaseIterable {
    // MARK: Public - Cases
    ...
    internal static let precedenceMap: [(check: ((ZeroOperator) -> Bool), infixed: Bool)] = [
    ...
    private static let states: [String: Set<ZeroOperator>] = [
