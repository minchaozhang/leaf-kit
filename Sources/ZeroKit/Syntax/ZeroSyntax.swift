...
extension Syntax: BodiedSyntax  {
    ...
    internal func inlineRefs(_ externals: [String: ZeroAST], _ imports: [String: Export]) -> [Syntax] {
        var result = [Syntax]()
        switch self {
            case .import(let im):
...
internal protocol BodiedSyntax {
    ...
    func inlineRefs(_ externals: [String: ZeroAST], _ imports: [String: Syntax.Export]) -> [Syntax]
}
...
extension Array: BodiedSyntax where Element == Syntax {
    ...
    internal func inlineRefs(_ externals: [String: ZeroAST], _ imports: [String: Syntax.Export]) -> [Syntax] {
        var result = [Syntax]()
                ...
                switch syntax {
                    ...
                    case .export(let export):
                        guard !export.externals().contains(self.key) else {
                            throw ZeroError(.cyclicalReference(self.key, [self.key]))
                        }
